...
vendas <- read.csv("C:\\Users\\Walter Pina\\Documents\\FGV\\08 Séries Temporais - Pedro\\ST_markdown\\data\\IBGE_VVCVA.csv", 
                   header=FALSE, 
                   dec=".",
                   stringsAsFactors = F)
...
Um gráfico interativo permite analisar melhor as variacoes da serie.
...
Vamos decompor agora a série em tres partes principais e aditivas: tendencia, componente sazonal e residuo, esse último idealmente deveria ser residuo branco.
